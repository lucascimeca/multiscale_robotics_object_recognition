...
from mlp.data_providers import YOLODataProvider
...
# load train data
train_data = YOLODataProvider('train', batch_size=30, convolution=True)
# valid_data = YOLODataProvider('valid', batch_size=30, convolution=True)
# load valid data
